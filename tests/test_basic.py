...
optimizers = [
    ...
    (optim.AdaMod, {'lr': 1.0, 'adamd_bias_correction': True}, 800),
    (optim.AdaBound, {'lr': 1.0}, 800),
    (optim.AdaBound, {'lr': 1.0, 'adamd_bias_correction': True}, 800),
    (optim.Yogi, {'lr': 1.0}, 500),
    (optim.Yogi, {'lr': 1.0, 'adamd_bias_correction': True}, 500),
    (optim.AccSGD, {'lr': 0.015}, 800),
    (build_lookahead, {'lr': 1.0}, 500),
    (optim.QHAdam, {'lr': 1.0}, 500),
    # FIXME find params that work for Lamb
    # (optim.Lamb, {'lr': 0.1, 'betas': (0.9, 0.95)}, 900),
    # (optim.Lamb, {'lr': 0.1, 'betas': (0.9, 0.95), 'debias': True,
    #               'adamd_bias_correction': True}, 900),
    (optim.Adam, {'lr': 0.01, 'betas': (0.9, 0.95)}, 900),
    (optim.AdamW, {'lr': 0.01, 'betas': (0.9, 0.95)}, 900),
    (
        optim.Adam,
        {'lr': 0.01, 'betas': (0.9, 0.95), 'adamd_bias_correction': True},
        900,
    ),
    (
        optim.AdamW,
    ...
    (optim.AdaBelief, {'lr': 1.0, 'adamd_bias_correction': True}, 500),
